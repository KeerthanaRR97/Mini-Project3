...
if page == "🏠 Introduction":
    ...
    st.image(r"D:\Guvi_Project3\Dataset\medical_insurance_img1.jpg",  use_container_width=True)
    st.markdown("""
...
# === EDA Page ===
    ...
    # Load dataset
    df = pd.read_csv(r"D:\Guvi_Project3\Dataset\medical_insurance.csv")
...
# === Prediction Page ===
    ...
    # Load best model
    best_run_id = "0a19c3936d624dfdae94f5162de45f6e"
